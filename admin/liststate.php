...
<?php 
	...
	if(isset($_REQUEST['search']))
	{
		...
		$sql = "select * from state where state_name like '$name%' or state_desc like '$name%'";
	...
	if(isset($_REQUEST['Delete']))
	{
		...
		$delsql="delete from state where state_id in (".$d.") ";
...
<form method="post" action="index.php?view=liststate.php">
...
<table align="center" width="70%" height="50%" class="table">
	<th colspan=6 class="th"> LIST OF STATES </th>
	<tr>
		<td class="tr">ID</td>
		<td class="tr">Name</td>
	...
	<tr>
		...
		<td><a style="width:40%" href="index.php?view=addstate.php&state_id=<?=$row[0];?>">Edit</a></td>
		<td>
